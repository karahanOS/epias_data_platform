...
**Status:** Accepted — full rollout + hourly schedule live 2026-07-24 (action items 1-6, 9 done; 7 done 2026-07-24; 8 — provisioning the small VM and moving the stack there — still open)
...
8. [ ] Provision the small VM (or confirm e2-micro Always-Free eligibility in project's region) and move the docker-compose stack (minus Spark) there.
